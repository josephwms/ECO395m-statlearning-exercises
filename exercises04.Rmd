...
First I started with a very low support and confidence levels and further tuned from there depending on the distribution I saw when I plotted the rules. Based on the spread of the confidence and lift, I changed my values in order to find that sweet spot of confidence where I am not being too restrictive and a value for lift to focus on more significant rules. Eventually, I arrived at the value of 0.01 for support and set confidence to 0.25.
...
170 is quite a large number for rules in this case. I would like more to analyze more significant associations so I will only focus on lifts that are greater than 2.
