...
# The ROC curve in this case is not exactly a curve but rather 2 perpendicular lines that intersect at (1,1). This means that the model has high sensitivity and high specificity and thus is effective at distinguishing between the two classes (poisonous and non-poisonous mushrooms).
...
# Based on the ROC curve I would recommend a probability threshold of 0.5017094. Since we have a false positive rate of 0 and a true positive of 1, it is safe to say that our model performs exceptionally well at this threshold. 
