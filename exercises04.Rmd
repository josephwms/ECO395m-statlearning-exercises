...
Next, we'll initialize association analysis with very low support and confidence levels and further tune from there depending on distributions we see when plotting the rules. 

Based on spread of confidence and lift, we tweaked support, confidence and minlen parameters to find a sweet spot where confidence is not too restrictive but there is enough variation in lift to identify the most significant associations. Eventually, we arrived at the value of 0.01 for support and set confidence to 0.25.
