...
```
A) The 95th percentile of heights for female competitors across all Athletics events is 183.
...
C) Generally, after the female participate in Olympics, the average age of swimmers has a upward trend over years. Before that, the male average age quickly reached a peak at 1924 and then fell down. 
...
run_knn <- function(train_data, test_data) {
  k_values = seq(2, 60, by = 2) # Define the range of k values
