...
# we tested various models and found that the xgboost model gives us the lowest rmse so we will continue to to quantify the average change in rental income per square foot 
