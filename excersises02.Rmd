...
# Based on the ROC curve I would recommend a probability threshold of 0.5017094. Since we have a false positive rate of 0 and a true positive of 1, it is safe to say that our model performs exceptionally well at this threshold. In conclusion, we are indeed able to predict whether a mushroom is poisonous or not by using machine learning. 
