...
We see that the 350 trim yields a higher optimal k.  This could in part be because there is more data from cars with the 350 trim (332 in the training df vs 233 for 65 AMGs).  There is also more data in the 65 AMG training set where mileage = 0.  Thus, a smaller k may avoid bias at the left and right bounds.
