...
# Random Forest
rf_model = randomForest(revenue ~ ., data = train_data, ntree = 500)
...
params = list(booster = "gbtree", eta = 0.1, max_depth = 6, subsample = 0.7, colsample_bytree = 0.7)
xgb_model = xgb.train(params = params, data = xgb_data, nrounds = 100, early_stopping_rounds = 10, watchlist = list(eval = xgb_data), verbose = 0)
...
# rmse_plot = ggplot(rmse_values, aes(x=Model, y=RMSE)) +
#   geom_col() +
